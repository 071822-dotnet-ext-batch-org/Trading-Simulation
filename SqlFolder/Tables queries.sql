Create Table Users
(
	userID nvarchar not null Primary Key,
...
(
	...
	fk_user1ID nvarchar not null Foreign Key References Users(userID),
	fk_user2ID nvarchar not null Foreign Key References Users(userID),
...
(
	...
	fk_userID nvarchar not null References Users(userID),
